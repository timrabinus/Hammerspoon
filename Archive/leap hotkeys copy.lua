...
-- this is the version that is using enabling and disabling, which might be ok
-- seems better than the other, but I think there may be some sloppiness in typing
-- that causes problems
-- overall the typing seems slower than normal, and the random go into search mode
-- is fucking annoying.
