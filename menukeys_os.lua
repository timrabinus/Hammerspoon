...
-- File menuItem
-- obj.AXMenuBar.AXChildren[3].AXTitle
-- Edit > Spelling and Grammar > Show Spelling and Grammar
-- obj.AXMenuBar.AXChildren[4].AXChildren[1].AXChildren[12].AXChildren[1].AXChildren[1]
-- Edit > File
-- obj.AXMenuBar.AXChildren[4].AXChildren[1].AXChildren[13].AXTitle
